...
class Bloom {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Bloom.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_bloom_free(ptr);
    }
    /**
    * Returns a new Bloom struct
    * @param {Uint8Array} bitmap
    * @param {number} bitmap_bits
    * @param {number} k_num
    * @param {Array<any>} sip_keys
    * @returns {Bloom}
    */
    static from_existing(bitmap, bitmap_bits, k_num, sip_keys) {
        try {
            var ret = wasm.bloom_from_existing(addBorrowedObject(bitmap), addBorrowedObject(bitmap_bits), addBorrowedObject(k_num), addBorrowedObject(sip_keys));
            return Bloom.__wrap(ret);
        } finally {
    ...
    */
    check(item) {
        try {
            var ret = wasm.bloom_check(this.ptr, addBorrowedObject(item));
            return ret !== 0;
        } finally {
            heap[stack_pointer++] = undefined;
        }
...
class RuleSets {
    ...
    */
    count_targets() {
        var ret = wasm.rulesets_count_targets(this.ptr);
        return ret >>> 0;
    }
    /**
    ...
    * @param {boolean} enable_mixed_rulesets
    ...
    */
    get_simple_rules_ending_with(ending) {
        try {
            var ret = wasm.rulesets_get_simple_rules_ending_with(this.ptr, addBorrowedObject(ending));
    ...
    */
    potentially_applicable(host) {
        try {
            var ret = wasm.rulesets_potentially_applicable(this.ptr, addBorrowedObject(host));
            return takeObject(ret);
        } finally {
            heap[stack_pointer++] = undefined;
        }
...
async function init(input) {
    ...
    imports.wbg.__wbg_valueOf_b48726e2b13a0979 = function(arg0) {
    ...
    imports.wbg.__wbg_valueOf_62022227b3a23762 = function(arg0) {
        var ret = getObject(arg0).valueOf();
        return ret;
    };
    ...
    imports.wbg.__wbg_isArray_cf6ef7e2eda8eafb = function(arg0) {
    ...
    imports.wbg.__wbg_values_fc8deb9aac2a7195 = function(arg0) {
    ...
    imports.wbg.__wbg_isInteger_85edc65525d5ee12 = function(arg0) {
    ...
    imports.wbg.__wbg_new_3bcf779d33c16832 = function(arg0, arg1, arg2, arg3) {
        var ret = new RegExp(getStringFromWasm0(arg0, arg1), getStringFromWasm0(arg2, arg3));
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_test_42f124d21ef71859 = function(arg0, arg1, arg2) {
        var ret = getObject(arg0).test(getStringFromWasm0(arg1, arg2));
        return ret;
    };
    imports.wbg.__wbg_toString_81e05fd560af17f9 = function(arg0) {
        var ret = getObject(arg0).toString();
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_add_9072e22765f89fef = function(arg0, arg1) {
        var ret = getObject(arg0).add(getObject(arg1));
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_new_3b5142da7bf17d3e = function(arg0) {
